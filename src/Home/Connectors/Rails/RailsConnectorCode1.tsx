export default `<span class="n">connector</span> <span class="o">=</span> <span class="no">Foobara</span><span class="o">::</span><span class="no">CommandConnectors</span><span class="o">::</span><span class="no">RailsCommandConnector</span><span class="p">.</span><span class="nf">new</span>
